...
public class ProviderConditional
{
	 ...
	 */
	public ProviderConditional(@NotNull ResourceLocation identifier, @NotNull ProviderConditionalType type, @Nullable Style style, @Nullable Skill skill, @Nullable SkillSlot slot, @Nullable SkillDataKey<Boolean> key, @Nullable Boolean combo)
	{
	 ...
	 */
	public ProviderConditional(@NotNull ResourceLocation identifier, @NotNull ProviderConditionalType type, Style style, @NotNull InteractionHand hand, @Nullable WeaponCategory category, @Nullable Item item, Boolean combo)
	{
		this.identifier = identifier;
		this.type = type;
		this.style = style;
	 ...
	 */
	public ProviderConditional(@NotNull ResourceLocation identifier, @NotNull ProviderConditionalType type, Style style, Boolean combination)
	{
		this.identifier = identifier;
		this.type = type;
		this.style = style;
	 ...
	 * @param combination The combo predicate logic whenever this is the true or false for dual wielding.
	 */
	public ProviderConditional(@NotNull ResourceLocation identifier, @NotNull ProviderConditionalType type, Style style, Boolean combination, ProviderConditional... conditionals)
	{
		this.identifier = identifier;
		this.type = type;
		this.style = style;
	 ...
	 */
	public ProviderConditional(@NotNull ResourceLocation identifier, @NotNull ProviderConditionalType type, Style style, Boolean combination, Function<LivingEntityPatch<?>, Boolean> booleanFunction)
	{
		this.identifier = identifier;
		this.type = type;
		this.style = style;
